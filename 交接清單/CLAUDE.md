...
### 8.3 2026 Q2 財報季已更新（截至 2026-08-02）
- **美股已更新 19+ 檔**：AAPL / MSFT / META / AMZN / V / MA / QCOM / KO / XOM / CVX / ABBV / VRT / BA / PYPL / SBUX / TSLA / ARM / LRCX / SKHY 等。
- **台股 Q2 待更新**：瑞昱(2379)、大立光(3008)、日月光(3711)、欣興(3037) 法說會已舉辦但常數尚未更新；緯創(3231) 6/4 已開但需確認；和碩(4938) 法說會 8/12；聯詠(3034) Q2 結果可能尚未發布；聯強(2345) 未查到 Q2。
- **即將到來**：SPOT Q2（8/4）、NVO H1（~8/5-6）、SMCI 正式版（8/11）。
...
- **當使用者開新對話時**：先讀取本檔（`交接清單/CLAUDE.md`）+ 交接記錄（`.claude/skills/交接手冊skill/交接記錄.md`）再開始工作。
...
| `CLAUDE.md` | 專案根目錄 | Claude Code 自動載入的簡版提醒 |
